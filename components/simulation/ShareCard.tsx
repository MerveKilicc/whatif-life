...
const ShareCard = forwardRef<HTMLDivElement>((props, ref) => {
  ...
  const activeAvatarUrl = useMemo(() => {
    ...
    const hairMap: Record<string, string> = {
      straight: "straight01", wavy: "shortWaved", curly: "curly",
      short: "shortFlat", long: "longButNotTooLong", bald: "shortRound"
    };
    const colorMap: Record<string, string> = {
      black: "2c1b18", brown: "724133", blonde: "d6b370",
      red: "ca4420", auburn: "a55728", gray: "e8e1e1"
    };
    const skinMap: Record<string, string> = {
      pale: "ffdbb4", fair: "edb98a", medium: "d08b5b", olive: "ae5d29", dark: "614335"
    };

    const top = hairMap[avatarData.hairStyle] || "shortFlat";
    const hColor = colorMap[avatarData.hairColor] || "724133";
    const skin = skinMap[avatarData.skinTone] || "edb98a";

    const params = new URLSearchParams({
      seed: encodeURIComponent(avatarData.name || "Traveller"), // Stable structural seed
      top: top,
      hairColor: hColor,
      skinColor: skin,
  ...
  return (
    <div ref={ref} className="w-full max-w-[350px] mx-auto bg-[#16213e] text-white p-6 rounded-xl border-4 border-[#ffd700] shadow-2xl flex flex-col gap-6 relative overflow-hidden font-sans">
      {/* Background Texture */}
      <img
        src="https://image.pollinations.ai/prompt/minimalist%20dark%20blue%20astrology%20chart%20texture%20zodiac%20constellations%20subtle%20elegant?width=512&height=800&nologo=true&seed=42"
        alt="bg"
